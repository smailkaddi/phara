    ...
    <header>
        ...
        <!-- Header End -->
                ...
                <a class="dropdown-item" href="home.php">TOUTS</a>
                    ...
                    <a class="dropdown-item" href="casa.php">AGADIR</a>
                    <a class="dropdown-item" href="agadir.php">CASA</a>
                </div>
     ...
     <section style="margin-top:2% ">
      <h2 style="margin-top:5%;text-align:center;">CASA:</h2>
      <div class="todolist" style="margin-top:3%;">
        <div class="column">
          <?php
              
            $posts = "SELECT  name, mail, tel, addrsse, day FROM phara where ville_id = '19' ";
