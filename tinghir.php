...
<body>
    ...
    <header>
        ...
        <!-- Header End -->
                ...
                <a class="dropdown-item" href="index.php">TOUTS</a>
     ...
     <section style="margin-top:2% ">
      <h2 style="margin-top:5%;text-align:center;">Tinghir:</h2>
      <div class="todolist" style="margin-top:3%;">
        <div class="column">
          <?php
              
            $posts = "SELECT  name, mail, tel, addrsse, day FROM phara where ville_id = '18' ";
