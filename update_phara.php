...
<header class="header_area">
      <div class="main_menu">
        <nav class="navbar navbar-expand-lg navbar-dark">
          <div class="container box_1620">
            <h1 class="navbar-brand logo_h" style="color: white; font-family: 'Poppins Medium'; font-size: x-large;">TO do list</span></h1>
  ...
  <div class="form" style="margin-top: 15%;">
    <form class="login-form" method="POST" action='<?php echo "phara_Update.php?id=". $id . "&t_id=" . $t_id ?>'>
      ...
      <input type="text" placeholder="Update"  value="<?php echo $_SESSION['tel'] ?> "name="tel"/>
      <input type="text" placeholder="Update" value="<?php echo $_SESSION['addrsse'] ?>  "name="addrsse"/>
      <input type="text" placeholder="Update"value="<?php echo $_SESSION['mail'] ?> "name="mail"/>
      <input type="text" placeholder="Update"value="<?php echo $_SESSION['day'] ?> "name="day"/>
